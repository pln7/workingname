Pour utiliser l'une des fonctions, il est indispensable d'importer tous les .js du répertoire.
...
json2.js : contient une fonction permettant d'effectuer le parse des json (à ne pas modifier, pas créé par nous)